...
def get_args_parser():
    ...
    # model parameters
    parser.add_argument('-model', default='CDEmotionNet', type=str, help='Name of model to train')
    ...
    #multimodal mode
    parser.add_argument('-use_multimodal', default=False, action='store_true', help='whether use multimodal mode')
    parser.add_argument('-extract_bio', default=False, action='store_true', help='whether to extract features of PPS')
    parser.add_argument('-bio_length',default=1,type=int,help='The sequence length of each peripheral physiological signal ')
    parser.add_argument('-bio_stride', default=1, type=int, help='The stride of each peripheral physiological signal ')
    ...
    parser.add_argument('-only_seg', default=False, action='store_true', help='whether only segment for eeg data')
    parser.add_argument('-TnF', default = False, action='store_true', help='whether to extract features on both time and frequency domain')
    ...
    parser.add_argument('-experiment_mode', default='sub_dependent', type=str, choices=['sub_dependent', 'sub_independent','cross_session'],
                        help='which experiment mode be selected')
    parser.add_argument('-split_type', default='front_back', type=str, choices=['kfold', 'leave_one_out', 'front_back', 'train_val_test'],
    ...
    parser.add_argument('-subject_divide', default=False, action='store_true', help="whether divide subjects into two parts")
    parser.add_argument('-subject_front', default = 12, type = int, help = "the number of subjects in the front part")
