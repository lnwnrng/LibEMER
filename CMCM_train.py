...
from Trainer.CMCMTraining import train

#deap valence
#CUDA_VISIBLE_DEVICES=1 nohup python CMCM_train.py -model CMCM -use_multimodal -dataset deap -dataset_path /data1/cxx/data/data_preprocessed_python/data_preprocessed_python -bounds 5 5 -label_used valence -onehot -feature_type de_lds -time_window 1 -sample_length 10 -stride 10 -bio_length 1280 -bio_stride 1280 -split_type kfold -fold_num 10 -lr 1e-4 -batch_size 30 -epochs 100 >CMCM/deap_reproduction.log
#0.8151/0.0444
#deap arousal
#CUDA_VISIBLE_DEVICES=2 nohup python CMCM_train.py -model CMCM -use_multimodal -dataset deap -dataset_path /data1/cxx/data/data_preprocessed_python/data_preprocessed_python -bounds 5 5 -label_used arousal -onehot -feature_type de_lds -time_window 1 -sample_length 10 -stride 10 -bio_length 1280 -bio_stride 1280 -split_type kfold -fold_num 10 -lr 1e-4 -batch_size 30 -epochs 100 >CMCM/deap_arousal_reproduction.log
#0.8210/0.0537

#seed dependent
#CUDA_VISIBLE_DEVICES=0 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting seed_multimodal_sub_dependent_train_val_test_setting -dataset_path /data1/cxx/data/SEED -dataset seed_de_lds -sample_length 10 -bio_length 10 -stride 1 -bio_stride 1 -batch_size 32 -seed 2025 -epochs 100 -lr 1e-4 -onehot >/data1/cxx/CMCM/seed_dependent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.7830/0.2092
#ALLRound Mean and Std of macro-f1 : 0.7208/0.2626

#seed independent
#CUDA_VISIBLE_DEVICES=1 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting seed_multimodal_sub_independent_train_val_test_setting -dataset_path /data1/cxx/data/SEED -dataset seed_de_lds -sessions 1 -sample_length 10 -bio_length 10 -stride 1 -bio_stride 1 -batch_size 32 -seed 2025 -epochs 100 -lr 1e-4 -onehot >/data1/cxx/CMCM/seed_independent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.2631/0.0860
#ALLRound Mean and Std of macro-f1 : 0.1558/ 0.0194

#seedv depend
#CUDA_VISIBLE_DEVICES=1 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting seedv_multimodal_sub_dependent_train_val_test_setting -dataset_path SEEDV -dataset seedv_de_lds -sample_length 10 -bio_length 10 -stride 1 -bio_stride 1 -batch_size 32 -seed 2025 -epochs 100 -lr 1e-4 -onehot >/data1/cxx/CMCM/seedv_dependent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.1397/0.2410
#ALLRound Mean and Std of macro-f1 : 0.0877/0.1594

#seedv indep
#CUDA_VISIBLE_DEVICES=2 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting seedv_multimodal_sub_independent_train_val_test_setting -dataset_path SEEDV -dataset seedv_de_lds -sessions 1 -sample_length 10 -bio_length 10 -stride 1 -bio_stride 1 -batch_size 32 -seed 2025 -epochs 100 -lr 1e-4 -onehot >/data1/cxx/CMCM/seedv_independent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.4292/0.1247
#ALLRound Mean and Std of macro-f1 : 0.4315/0.1305

#deapv depend
#CUDA_VISIBLE_DEVICES=0 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting deap_multimodal_sub_dependent_train_val_test_setting -dataset_path /data1/cxx/data/data_preprocessed_python/data_preprocessed_python -dataset deap -time_window 1 -feature_type de_lds -sample_length 10 -bio_length 1280 -stride 1 -bio_stride 128 -bounds 5 5 -label_used valence -seed 2025 -onehot -batch_size 32 -epochs 100 -lr 1e-4 >/data1/cxx/CMCM/deapv_dependent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.5590/0.1298
#ALLRound Mean and Std of macro-f1 : 0.5121/0.1416

#deapv indep
#CUDA_VISIBLE_DEVICES=3 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting deap_multimodal_sub_independent_train_val_test_setting -dataset_path /data1/cxx/data/data_preprocessed_python/data_preprocessed_python -dataset deap -time_window 1 -feature_type de_lds -sample_length 10 -bio_length 1280 -stride 1 -bio_stride 128 -bounds 5 5 -label_used valence -seed 2025 -onehot -batch_size 32 -epochs 100 -lr 1e-4 >/data1/cxx/CMCM/deapv_independent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.5575/0.0511
#ALLRound Mean and Std of macro-f1 : 0.4984/0.0525

#deapa depend
#CUDA_VISIBLE_DEVICES=0 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting deap_multimodal_sub_dependent_train_val_test_setting -dataset_path /data1/cxx/data/data_preprocessed_python/data_preprocessed_python -dataset deap -time_window 1 -feature_type de_lds -sample_length 10 -bio_length 1280 -stride 1 -bio_stride 128 -bounds 5 5 -label_used arousal -seed 2025 -onehot -batch_size 32 -epochs 100 -lr 1e-4 >/data1/cxx/CMCM/deapa_dependent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.5914/0.1641
#ALLRound Mean and Std of macro-f1 : 0.5219/0.1410

#deapa indep
#CUDA_VISIBLE_DEVICES=2 nohup python CMCM_train.py -model CMCM -use_multimodal -metrics 'acc' 'macro-f1' -metric_choose 'macro-f1' -setting deap_multimodal_sub_independent_train_val_test_setting -dataset_path /data1/cxx/data/data_preprocessed_python/data_preprocessed_python -dataset deap -time_window 1 -feature_type de_lds -sample_length 10 -bio_length 1280 -stride 1 -bio_stride 128 -bounds 5 5 -label_used arousal -seed 2025 -onehot -batch_size 32 -epochs 100 -lr 1e-4 >/data1/cxx/CMCM/deapa_independent_train_val_test_lr1e-4.log
#ALLRound Mean and Std of acc : 0.4761/0.0547
#ALLRound Mean and Std of macro-f1 : 0.4661/0.0629
...
def main(args):
    ...
    '''setting.extract_bands = [[0.5,4],[4,8],[8,12],[12,30],[30,50]]
    ...
    if setting.dataset.startswith('seed'):
        ...
        for rridx, (eeg_data_i, bio_data_i, label_i) in enumerate(zip(eeg_data, bio_data, label)):
            ...
            for ridx,(train_indexes, test_indexes, val_indexes)  in enumerate(zip(tts['train'], tts['test'], tts['val'])):
                ...
                train_bio = train_bio.reshape(train_bio.shape[0], bio_channels, -1 , sample_rate).transpose(0,2, 1, 3)
                train_bio = train_bio.reshape(train_bio.shape[0], train_bio.shape[1], -1)
                val_bio = val_bio.reshape(val_bio.shape[0], bio_channels, -1 , sample_rate).transpose(0,2,1,3)
                val_bio = val_bio.reshape(val_bio.shape[0], val_bio.shape[1], -1)
                test_bio = test_bio.reshape(test_bio.shape[0], bio_channels, -1 , sample_rate).transpose(0,2,1,3)
                test_bio = test_bio.reshape(test_bio.shape[0], test_bio.shape[1], -1)

                eeg_input_dim = eeg_channels * eeg_feature_dim
                bio_input_dim = bio_channels * sample_rate
                seq_len = train_eeg.shape[1]
                embed_dim = 1024
                window_size =7
                num_heads = 8
